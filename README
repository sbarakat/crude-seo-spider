...
Provides a simple method of spidering a website to provide some basic
...
1. First open the edit the spider.pl script and at the top set the full path to
the lib directory.
